...
function processEnumDefinition(json, fieldId = 'id', fieldValue = 'value')
{
...
async function processSchema(json)
{
  ...
  {
    const {fieldId, fieldValue, headers, uri: metaUri, placeholders} = (meta || {})
    ...
    if(enumInfo)
      json.enum = processEnumDefinition(enumInfo, fieldId, fieldValue)
  }
